...
public class CourseActivity extends AppCompatActivity implements View.OnTouchListener {
...
//        getSupportActionBar().hide();
        ...
        //拿到数据库对象，为了读取数据
        DBHelper dbHelper = new DBHelper(CourseActivity.this, DB_NAME, null, 1);
    ...
    public void applyDraw(DBHelper dbHelper) {
        ...
        for (Classes aClass : classes) {
            ...
            //星期几
            int j = util.getDay(aClass.getC_day());
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        menuItem.setOnMenuItemClickListener(new MenuItem.OnMenuItemClickListener() {
            ...
            public boolean onMenuItemClick(MenuItem menuItem) {
                ...
                intent.setClass(CourseActivity.this, DialogModal.class);
...
//        Cursor cursor = db.query(TABLE_NAME, null, "c_id=?", new String[]{String.valueOf(textView.getId())}, null, null, null);
                ...
                if (!cursor.isAfterLast()) {
                    ...
                    intent.setClass(CourseActivity.this, Detail.class);
                    startActivity(intent);
